...
export const updateQuestionPosition = (questionnaireId: number, data: { activeIndex: number, overIndex: number }): AxiosPromise<Question[]> => {
    return request({
        url: `/questionnaire/${questionnaireId}/question/position`,
        method: "put",
        data
    });
};