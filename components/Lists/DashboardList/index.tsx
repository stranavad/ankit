        ...
        <TableContent>
            {questionnaires.map((questionnaire) => (
                <TableRow key={questionnaire.id}>
                    ...
                    <TableItem className="text-xs">
                        {questionnaire.spaceName}
                    </TableItem>
                    <TableItem className="align-middle">
                        <QuestionnaireActions questionnaire={questionnaire} removeQuestionnaire={removeQuestionnaire} removeDisabled={deleteButtonDisabled(questionnaire)}/>
                    </TableItem>
                </TableRow>
            ))}
        </TableContent>
