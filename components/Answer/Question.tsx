        ...
        <div className="bg-white dark:bg-slate-700 w-full rounded-xl p-5 my-10">
            ...
            <div className="h-0.5 w-full bg-slate-500 mt-2 mb-4"/>
            {
                question.type === QuestionType.TEXT ? (
                    <textarea value={bundle.answer.value} onChange={answerText} placeholder="Your answer" className="max-h-32 min-h-[50px] text-sm bg-transparent border-2 w-full outline-none p-1 text-slate-800 dark:text-slate-200 rounded-md border-slate-200 dark:border-slate-800"/>
                ) : (
