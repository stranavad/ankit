        ...
        <>
            ...
            <div className="mt-1 flex items-center justify-between">
                <div className="flex w-full max-w-lg md:max-w-xl">
                    <span className="inline-flex items-center rounded-l-md border border-r-0 border-gray-300 bg-gray-50 px-3 text-xs md:text-sm text-gray-500">
                    ...
                    />
                    <IconButton className="pl-2" icon={DocumentDuplicateIcon} color="primary" size="medium" onClick={() => copyQuestionnaireLink(questionnaire)}/>
                </div>
                {showEditButtons && (
                    <div>
                        <IconButton icon={CheckIcon} color="success" size="medium" onClick={() => updateUrl(url)} className="mr-2" disabled={disabledSaveButton}/>
