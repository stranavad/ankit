...
const getQuestionsWithAnswers = (questions: AnswerQuestion[]): {
...
const Questionnaire = ({ questionnaire }: QuestionnaireProps) => {
    const {
        ...
        required
    } = useMemo(() => getQuestionsWithAnswers(questionnaire.questions), [questionnaire.questions]);
            ...
            <AnswerScreen translate={questionsTranslate}>
                <div className="max-w-xl w-full flex flex-col items-center">
                    {questions.map((question, index) => (
                        <Question bundle={question} key={index}
                                  setAnswer={(e) => setAnswer(e, index, question.question.questionId)} />
                    ))}
